...
export const Budget: React.FC = () => {
  ...
  const load = async () => {
    const [res, categoriesRes] = await Promise.all([
      authFetch(`${API}/api/budgets/${year}/${month}`),
